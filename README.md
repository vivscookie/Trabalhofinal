...
# Aluga Tuga - Desenvolvimento Web Front-End
...
Projeto final da unidade curricular DWFE.

## Itens obrigatórios
- Página inicial com catálogo ou listagem de itens
- Página de detalhes do produto
- Página com as autoras do site e informações para notas
- Página de contato com mapa e formulário
- Uso de um mapa, um vídeo e um áudio

## Templates utilizados

[Barra de navegação](https://getbootstrap.com/docs/5.3/components/navbar/)

[Ícones animados de redes sociais](https://bbbootstrap.com/snippets/animated-social-media-icons-98709190#)
...
- [@annaadddwhwhyh](https://github.com/annaadddwhwhyh)
